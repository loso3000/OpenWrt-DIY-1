...
rm -rf package/luci-app-openclash/root/usr/share/openclash/yacd
...
#  openvpn  openwrt-19.07/
rm -rf  feeds/luci/applications/luci-app-openvpn &&
svn co https://github.com/openwrt/luci/branches/openwrt-19.07/luci/applications/luci-app-openvpn ./package/lean/luci-app-openvpn
